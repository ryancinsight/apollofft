...
/// Forward FFT (f16 storage) for power-of-sixteen lengths via f32 upcast.
...
/// Forward FFT (f16 storage) for power-of-sixteen lengths using caller-provided twiddles.
